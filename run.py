...
def main():
    ...
    tfp.training(sess=sess, neuralnet=neuralnet, saver=saver, dataset=dataset, epochs=FLAGS.epoch, batch_size=FLAGS.batch, canvas_size=FLAGS.canvas, sequence_length=FLAGS.seqlen, print_step=5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch', type=int, default=5500, help='Batch size for training.')
